...
const Comments = () => {
    ...
    const fetchPostContents = () => {
        axios.get("http://192.168.1.176:1111/getpost")
            .then((response) => {
    ...
    const fetchOldcomments = () => {
        axios.get("http://192.168.1.176:1111/getcomments")
            .then((response) => {
    ...
    const handleSubmit = (event) => {
        ...
        axios.post("http://192.168.1.176:1111/addcomment", { comment: currentcomment })
            .then((response) => {
        ...
        <div className="commentsection">
            ...
            <div className="viewpost">
                ...
                <div className="post-body">
                    <img src={`http://192.168.1.176:1111/${(postcontents.file).split('/').pop()}`} alt="post" />
